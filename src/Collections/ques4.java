...
public class ques4 {
    ...
    public static void main(String[]args){
        ques4 emp1 = new ques4("kritika",23,"Software Developer",25000);
        ques4 emp2 = new ques4("vijay",23,"System Engineer", 31000);
        ques4 emp3 = new ques4("hema",23, "Associate System Engineer",29000);
        ques4 emp4 = new ques4("pankaj",21,"Tester", 60000);
        ques4 emp5 = new ques4("moksh",23,"Developer",62000);
